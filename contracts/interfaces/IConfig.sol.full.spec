...
contract IConfig is IConfigLibEvents
{
	 ...
	 * @return bool
	 */
	function enableDeposits() public returns (bool);
	
	function disableDeposits() public returns (bool);
	
	/**
	 * @dev Enable withdrawals if they are disabled, executed only by admin.
	 * @return bool
	 */
	function enableWithdrawals() public returns (bool);
	
	function disableWithdrawals() public returns (bool);
	 ...
	 * @return bool.
	 */
	function enableKYC() public returns (bool success);
	
	function disableKYC() public returns (bool success);
